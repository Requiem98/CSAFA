...
from models.modules.bam import BAM
from models.modules.PCA import LearnablePCA
from models.Siamese_VGGEM16.Siamese_vggem16 import N_conv
    

class BAM_VGGEM16(nn.Module):
...
class Siamese_BAM_VGGEM16(nn.Module):
    def __init__(self, in_channels:int = 3):
        super().__init__()
        
        self.vggem = BAM_VGGEM16(in_channels)
...
class Semi_Siamese_BAM_VGGEM16(nn.Module):
    def __init__(self, in_channels:int = 3):
        super().__init__()
        
        self.vggem_A = BAM_VGGEM16(in_channels)
        self.vggem_B = BAM_VGGEM16(in_channels)
...
class Siamese_BAM_VGGEM16_v0_l(pl.LightningModule):
    def __init__(self, img_size : dict, in_channels:int = 3, **kargs):
        ...
        self.model = Siamese_BAM_VGGEM16(in_channels)
...
class Siamese_BAM_VGGEM16_v1_l(pl.LightningModule):
    def __init__(self, img_size : dict, in_channels:int = 3, **kargs):
        super().__init__()
        ...
        self.example_input_array = (torch.Tensor(2, 3, img_H, img_W), torch.Tensor(2, 3, img_H, img_W))
        
        self.model = Semi_Siamese_BAM_VGGEM16(in_channels)
...
class Siamese_BAM_VGGEM16_v2_l(pl.LightningModule):
    def __init__(self, img_size : dict, in_channels:int = 3, **kargs):
        super().__init__()
