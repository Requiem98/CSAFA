...
class Siamese_CBAM_VGGEM16(nn.Module):
    def __init__(self, in_channels:int = 3):
        super().__init__()
        
        self.vggem = CBAM_VGGEM16(in_channels)
...
class Semi_Siamese_CBAM_VGGEM16(nn.Module):
    def __init__(self, in_channels:int = 3):
        super().__init__()
        
        self.vggem_A = CBAM_VGGEM16(in_channels)
        self.vggem_B = CBAM_VGGEM16(in_channels)
...
class Siamese_CBAM_VGGEM16_v0_l(pl.LightningModule):
    def __init__(self, img_size : dict, in_channels:int = 3, **kargs):
        ...
        self.model = Siamese_CBAM_VGGEM16(in_channels)
...
class Siamese_CBAM_VGGEM16_v1_l(pl.LightningModule):
    def __init__(self, img_size : dict, in_channels:int = 3, **kargs):
        super().__init__()
        ...
        self.model = Semi_Siamese_CBAM_VGGEM16(in_channels)
...
class Siamese_CBAM_VGGEM16_v2_l(pl.LightningModule):
    def __init__(self, img_size : dict, in_channels:int = 3, **kargs):
        super().__init__()
